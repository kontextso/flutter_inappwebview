...
public class InAppWebViewManager extends ChannelDelegateImpl {
  ...
  public static final String METHOD_CHANNEL_NAME = "so.kontext/flutter_inappwebview_kontext_manager";
  ...
  public InAppWebViewManager(final InAppWebViewFlutterPluginKontext plugin) {
