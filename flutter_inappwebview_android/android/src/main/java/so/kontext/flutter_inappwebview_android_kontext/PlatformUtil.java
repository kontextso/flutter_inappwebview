...
public class PlatformUtil extends ChannelDelegateImpl {
  ...
  public static final String METHOD_CHANNEL_NAME = "so.kontext/flutter_inappwebview_kontext_platformutil";
  
  @Nullable
  public InAppWebViewFlutterPluginKontext plugin;

  public PlatformUtil(final InAppWebViewFlutterPluginKontext plugin) {
