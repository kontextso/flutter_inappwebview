package so.kontext.flutter_inappwebview_android_kontext.headless_in_app_webview;
...
public class HeadlessInAppWebView implements Disposable {
  ...
  public static final String METHOD_CHANNEL_NAME_PREFIX = "so.kontext/flutter_headless_inappwebview_kontext_";
  ...
  public HeadlessInAppWebView(@NonNull final InAppWebViewFlutterPluginKontext plugin, @NonNull String id, @NonNull FlutterWebView flutterWebView) {
    this.id = id;
    this.plugin = plugin;
