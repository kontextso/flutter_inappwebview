...
public class Util {
    public static func getUrlAsset(plugin: SwiftFlutterKontextPlugin, assetFilePath: String) throws -> URL {
    ...
    public static func getAbsPathAsset(plugin: SwiftFlutterKontextPlugin, assetFilePath: String) throws -> String {
        guard let key = plugin.registrar?.lookupKey(forAsset: assetFilePath),
