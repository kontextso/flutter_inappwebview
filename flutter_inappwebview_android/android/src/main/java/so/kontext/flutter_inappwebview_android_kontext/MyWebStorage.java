...
public class MyWebStorage extends ChannelDelegateImpl {
  ...
  public static final String METHOD_CHANNEL_NAME = "so.kontext/flutter_inappwebview_kontext_webstoragemanager";
  ...
  public MyWebStorage(@NonNull final InAppWebViewFlutterPluginKontext plugin) {
