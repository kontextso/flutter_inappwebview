...
public class MyCookieManager extends ChannelDelegateImpl {
  ...
  public static final String METHOD_CHANNEL_NAME = "so.kontext/flutter_inappwebview_kontext_cookiemanager";
  @Nullable
  public static CookieManager cookieManager;
  @Nullable
  public InAppWebViewFlutterPluginKontext plugin;

  public MyCookieManager(@NonNull final InAppWebViewFlutterPluginKontext plugin) {
