...
public interface InAppWebViewInterface {
  ...
  void postWebMessage(so.kontext.flutter_inappwebview_android_kontext.types.WebMessage message, Uri targetOrigin, ValueCallback<String> callback) throws Exception;
  ...
  InAppWebViewFlutterPluginKontext getPlugin();
  void setPlugin(InAppWebViewFlutterPluginKontext plugin);
