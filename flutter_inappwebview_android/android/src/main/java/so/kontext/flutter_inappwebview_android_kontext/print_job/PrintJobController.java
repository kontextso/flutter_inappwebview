package so.kontext.flutter_inappwebview_android_kontext.print_job;
...
import so.kontext.flutter_inappwebview_android_kontext.types.PrintJobInfoExt;
...
public class PrintJobController implements Disposable  {
  ...
  public static final String METHOD_CHANNEL_NAME_PREFIX = "so.kontext/flutter_inappwebview_kontext_printjobcontroller_";
  ...
  public PrintJobController(@NonNull String id, @NonNull android.print.PrintJob job,
                            @Nullable PrintJobSettings settings, @NonNull InAppWebViewFlutterPluginKontext plugin) {
    this.id = id;
    this.plugin = plugin;
    this.job = job;
