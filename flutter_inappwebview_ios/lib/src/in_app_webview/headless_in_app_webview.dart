...
class IOSHeadlessInAppWebView extends PlatformHeadlessInAppWebView
  ...
  static const MethodChannel _sharedChannel =
      const MethodChannel('so.kontext/flutter_inappwebview_ios_kontext_headless_inappwebview');
  ...
  _init() {
    ...
    channel =
        MethodChannel('so.kontext/flutter_inappwebview_ios_kontext_headless_inappwebview_$id');
