...
import so.kontext.flutter_inappwebview_android_kontext.chrome_custom_tabs.ChromeSafariBrowserManager;
import so.kontext.flutter_inappwebview_android_kontext.chrome_custom_tabs.NoHistoryCustomTabsActivityCallbacks;
import so.kontext.flutter_inappwebview_android_kontext.credential_database.CredentialDatabaseHandler;
import so.kontext.flutter_inappwebview_android_kontext.headless_in_app_webview.HeadlessInAppWebViewManager;
import so.kontext.flutter_inappwebview_android_kontext.in_app_browser.InAppBrowserManager;
import so.kontext.flutter_inappwebview_android_kontext.print_job.PrintJobManager;
import so.kontext.flutter_inappwebview_android_kontext.omid.OmidSessionManager;
import so.kontext.flutter_inappwebview_android_kontext.process_global_config.ProcessGlobalConfigManager;
import so.kontext.flutter_inappwebview_android_kontext.proxy.ProxyManager;
import so.kontext.flutter_inappwebview_android_kontext.service_worker.ServiceWorkerManager;
import so.kontext.flutter_inappwebview_android_kontext.tracing.TracingControllerManager;
import so.kontext.flutter_inappwebview_android_kontext.webview.FlutterWebViewFactory;
import so.kontext.flutter_inappwebview_android_kontext.webview.InAppWebViewManager;
...
public class InAppWebViewFlutterPluginKontext implements FlutterPlugin, ActivityAware {
  ...
  public InAppWebViewFlutterPluginKontext() {}
