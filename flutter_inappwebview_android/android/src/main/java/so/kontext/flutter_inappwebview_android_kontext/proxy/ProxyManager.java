package so.kontext.flutter_inappwebview_android_kontext.proxy;
...
import so.kontext.flutter_inappwebview_android_kontext.types.ProxyRuleExt;
...
public class ProxyManager extends ChannelDelegateImpl {
  ...
  public static final String METHOD_CHANNEL_NAME = "so.kontext/flutter_inappwebview_kontext_proxycontroller";
  ...
  public ProxyManager(@NonNull final InAppWebViewFlutterPluginKontext plugin) {
