...
public class HeadlessInAppWebViewManager extends ChannelDelegateImpl {
  ...
  public static final String METHOD_CHANNEL_NAME = "so.kontext/flutter_headless_inappwebview_kontext";
  
  public final Map<String, HeadlessInAppWebView> webViews = new HashMap<>();
  @Nullable
  public InAppWebViewFlutterPluginKontext plugin;

  public HeadlessInAppWebViewManager(final InAppWebViewFlutterPluginKontext plugin) {
