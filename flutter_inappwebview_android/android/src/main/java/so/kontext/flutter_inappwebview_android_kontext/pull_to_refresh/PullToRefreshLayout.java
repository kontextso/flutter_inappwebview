package so.kontext.flutter_inappwebview_android_kontext.pull_to_refresh;
...
public class PullToRefreshLayout extends SwipeRefreshLayout implements Disposable {
  ...
  public static final String METHOD_CHANNEL_NAME_PREFIX = "so.kontext/flutter_inappwebview_kontext_pull_to_refresh_";
  
  @Nullable
  public PullToRefreshChannelDelegate channelDelegate;
  public PullToRefreshSettings settings = new PullToRefreshSettings();

  public PullToRefreshLayout(@NonNull Context context, @NonNull InAppWebViewFlutterPluginKontext plugin, 
