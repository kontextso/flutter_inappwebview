package so.kontext.flutter_inappwebview_android_kontext.credential_database;
...
public class CredentialDatabaseHandler extends ChannelDelegateImpl {
  ...
  public static final String METHOD_CHANNEL_NAME = "so.kontext/flutter_inappwebview_kontext_credential_database";
  ...
  public CredentialDatabaseHandler(@NonNull final InAppWebViewFlutterPluginKontext plugin) {
    super(new MethodChannel(plugin.messenger, METHOD_CHANNEL_NAME));
    this.plugin = plugin;
  }

  public static void init(@NonNull InAppWebViewFlutterPluginKontext plugin) {
