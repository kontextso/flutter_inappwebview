...
public class ServiceWorkerManager implements Disposable {
  ...
  public static final String METHOD_CHANNEL_NAME = "so.kontext/flutter_inappwebview_kontext_serviceworkercontroller";
  ...
  public ServiceWorkerManager(@NonNull final InAppWebViewFlutterPluginKontext plugin) {
    this.plugin = plugin;
