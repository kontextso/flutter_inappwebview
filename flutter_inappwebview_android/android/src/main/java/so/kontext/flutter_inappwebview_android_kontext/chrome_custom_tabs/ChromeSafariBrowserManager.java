...
public class ChromeSafariBrowserManager extends ChannelDelegateImpl {
  ...
  public static final String METHOD_CHANNEL_NAME = "so.kontext/flutter_chromesafaribrowser_kontext";
  ...
  public ChromeSafariBrowserManager(final InAppWebViewFlutterPluginKontext plugin) {
