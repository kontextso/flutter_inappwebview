...
import so.kontext.flutter_inappwebview_android_kontext.credential_database.CredentialDatabase;
...
import so.kontext.flutter_inappwebview_android_kontext.types.URLCredential;
import so.kontext.flutter_inappwebview_android_kontext.types.URLProtectionSpace;
...
public class InAppWebViewClient extends WebViewClient {
  ...
  public void onSafeBrowsingHit(final WebView view, final WebResourceRequest request, final int threatType, final SafeBrowsingResponse callback) {
    ...
    final WebViewChannelDelegate.SafeBrowsingHitCallback resultCallback = new WebViewChannelDelegate.SafeBrowsingHitCallback() {
      @Override
      public boolean nonNullSuccess(@NonNull so.kontext.flutter_inappwebview_android_kontext.types.SafeBrowsingResponse response) {
        Integer action = response.getAction();
        if (action != null) {
      ...
      @Override
      public void defaultBehaviour(@Nullable so.kontext.flutter_inappwebview_android_kontext.types.SafeBrowsingResponse result) {
