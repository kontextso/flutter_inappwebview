...
public class InAppBrowserManager extends ChannelDelegateImpl {
  ...
  public static final String METHOD_CHANNEL_NAME = "so.kontext/flutter_inappbrowser_kontext";
  ...
  public InAppBrowserManager(final InAppWebViewFlutterPluginKontext plugin) {
