...
import so.kontext.flutter_inappwebview_android_kontext.types.Size2D;
...
public class Util {
  ...
  public static String getUrlAsset(InAppWebViewFlutterPluginKontext plugin, String assetFilePath) throws IOException {
  ...
  public static InputStream getFileAsset(InAppWebViewFlutterPluginKontext plugin, String assetFilePath) throws IOException {
    String key = plugin.flutterAssets.getAssetFilePathByName(assetFilePath);
  ...
  @Nullable
  public static PrivateKeyAndCertificates loadPrivateKeyAndCertificate(@NonNull InAppWebViewFlutterPluginKontext plugin,
