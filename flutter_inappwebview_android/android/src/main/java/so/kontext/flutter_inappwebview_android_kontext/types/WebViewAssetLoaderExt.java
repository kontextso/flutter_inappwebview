...
public class WebViewAssetLoaderExt implements Disposable {
  ...
  @Nullable
  public static WebViewAssetLoaderExt fromMap(@Nullable Map<String, Object> map, @NonNull InAppWebViewFlutterPluginKontext plugin, @NonNull Context context) {
    if (map == null) {
      return null;
    }
  ...
  public static class PathHandlerExt implements WebViewAssetLoader.PathHandler, Disposable {
    ...
    public static final String METHOD_CHANNEL_NAME_PREFIX = "so.kontext/flutter_inappwebview_kontext_custompathhandler_";
    ...
    public PathHandlerExt(@NonNull String id, @NonNull InAppWebViewFlutterPluginKontext plugin) {
      this.id = id;
